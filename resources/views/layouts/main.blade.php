...
<head>
    ...
    <link rel="icon" href="https://cdn-icons-png.flaticon.com/512/2699/2699194.png" />
    <title>Movie App</title>

    {{-- font awesome kit icons pack --}}
    <script src="https://kit.fontawesome.com/28a02cc159.js" crossorigin="anonymous"></script>
...
<body class="font-sans text-white bg-gray-900">
    <nav class="border-b border-gray-800">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-8 lg:px-32 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                  <livewire:search-dropdown />
                    <div class="md:ml-4 mt-3 md:mt-0">
                        <a href="#">
                            <img src="https://avatars.githubusercontent.com/u/72402618?s=400&u=86590fc0cec3d301fc384db27aa8e074a6f07939&v=4" alt="avatar" class="rounded-full w-8 h-8">
                        </a>
                    </div>
            </div>
        </div>
